        ...
        <div className="mx-10 md:mx-10 lg:mx-20">
            ...
            <div>
                <div className="flex flex-col mb-7 md:flex-row lg:flex-row items-center md:gap-x-4 lg:gap-x-10 shadow-xl p-5 md:p-4 lg:p-7 rounded-lg">
                    ...
                    <NavLink to='https://turbotrade-753dc.web.app/' target="_blank"><button className="font-bold my-5 btn text-white bg-blue-400 hover:text-black">Explore</button></NavLink>
                </div>
                <div className="flex flex-col mb-7 md:flex-row lg:flex-row items-center md:gap-x-4 lg:gap-x-10 shadow-xl p-5 md:p-4 lg:p-7 rounded-lg">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 my-3 lg:w-3/4">Revolutionize hiring and job seeking on our platform. Streamlined job posting and application process, connecting employers with top talent and candidates with their dream opportunities effortlessly.</p>
                    </div>
                    <NavLink to='https://career-vista.firebaseapp.com/' target="_blank"><button className="font-bold my-5 btn text-white bg-blue-400 hover:text-black">Explore</button></NavLink>
                </div>
                <div className="flex flex-col md:flex-row lg:flex-row items-center md:gap-x-4 lg:gap-x-10 shadow-xl p-5 md:p-4 lg:p-7 rounded-lg">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 my-3 lg:w-3/4">Empower opinions with our user-friendly survey website. Seamlessly design, distribute, and analyze surveys for valuable insights. Transform data into actionable results effortlessly.</p>
                    </div>
                    <NavLink to='https://survey-plus-18f6b.firebaseapp.com/' target="_blank"><button className="font-bold my-5 btn text-white bg-blue-400 hover:text-black">Explore</button></NavLink>
                </div>
            </div>
        </div>
    );
